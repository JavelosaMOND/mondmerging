            ...
            <div class="card-body">
                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <span class="fw-bold">{{ $weeklyCount ?? 0 }}</span>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <span>Monthly Reports</span>
                        <span class="fw-bold">{{ $monthlyCount ?? 0 }}</span>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <span>Quarterly Reports</span>
                        <span class="fw-bold">{{ $quarterlyCount ?? 0 }}</span>
                    </div>
                    <div class="d-flex justify-content-between">
                        <span>Annual Reports</span>
                        <span class="fw-bold">{{ $annualCount ?? 0 }}</span>
                    </div>
                </div>
            </div>
        </div>
